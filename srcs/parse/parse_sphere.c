...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/25 14:55:54 by younhwan          #+#    #+#             */
/*   Updated: 2023/02/25 14:55:55 by younhwan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_bool	parse_sphere(t_var *var, char **splited)
{
	...
	if (parse_vec3(var, &sphere->center, splited[0]) == FALSE || \
		parse_radius(var, &sphere->radius, splited[1]) == FALSE || \
		parse_vec3(var, &sphere->color, splited[2]) == FALSE || \

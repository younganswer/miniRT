...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   parse_ambient_lightning_bonus.c                    :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: younhwan <younhwan@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/25 14:56:09 by younhwan          #+#    #+#             */
/*   Updated: 2023/02/25 14:56:10 by younhwan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_bool	parse_ambient_lightning(t_var *var, char **splited)
{
	...
	return (
		...
		parse_vec3(var, &var->alight->color, splited[1]) && \
		color_range_is_valid(var, var->alight->color)
	);
}
